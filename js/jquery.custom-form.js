...
;(function($, window) {
	...
	jcf.addModule({
		...
		attachEvents: function() {
			...
			this.fakeElement.next('label').on('touchstart', this.onFakeClick);
			this.fakeElement.on('jcf-pointerdown', this.onFakeClick);
...
;(function($, window) {
	...
	function ComboBox(options) {
		this.options = $.extend({
			...
			flipDropToFit: true,
			maxVisibleItems: 10,
			fakeAreaStructure: '<div class="jcf-select"><div class="jcf-select-text"></div><div class="jcf-select-opener"></div></div>',
